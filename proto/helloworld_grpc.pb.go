...
type GreeterClient interface {
	...
	SayBye(ctx context.Context, in *ByeRequest, opts ...grpc.CallOption) (*HelloReply, error)
...
func (c *greeterClient) SayBye(ctx context.Context, in *ByeRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
type GreeterServer interface {
	...
	SayBye(context.Context, *ByeRequest) (*HelloReply, error)
...
func (UnimplementedGreeterServer) SayBye(context.Context, *ByeRequest) (*HelloReply, error) {
